    ...
    '0TWp': function(e, t, n) {
      !(function() {
        ...
        Zone.__load_patch('ZoneAwarePromise', function(t, n, r) {
          ...
          function P(e, t, o) {
            ...
            if (e[g] === T) {
              ...
              if (t !== E && o instanceof M && o.hasOwnProperty(g) && o.hasOwnProperty(y) && o[g] !== T)
                j(o), P(e, o[g], o[y]);
                ...
                if (
                  ...
                  p && a(o, O, { configurable: !0, enumerable: !1, writable: !0, value: p });
                }
        ...
        var w = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
          ...
          D =
            void 0 !== m.process && '[object process]' === {}.toString.call(m.process) && !w && !(!g || !y.HTMLElement),
          Z = {},
          z = function(e) {
            if ((e = e || m.event)) {
              var t = Z[e.type];
            ...
            k = function(t) {
              if ((t = t || e.event)) {
                ...
                if (r)
                  ...
                  else for (var o = r.slice(), a = 0; a < o.length && (!t || !0 !== t[G]); a++) m(o[a], n, t);
              }
            },
            _ = function(t) {
              if ((t = t || e.event)) {
              ...
              (n.args[0] = function() {
                try {
                  ...
                  (t.data && t.data.isPeriodic) ||
                    ('number' == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[J] = null));
                }
              }),
                ...
                'number' == typeof a ? (o = i[a]) : (o = a && a[J]) || (o = a),
                  o && 'string' == typeof o.type
                    ? 'notScheduled' !== o.state &&
                      ...
                      ('number' == typeof a ? delete i[a] : a && (a[J] = null), o.zone.cancelTask(o))
                    : t.apply(e, r);
              };
            }));
        }
